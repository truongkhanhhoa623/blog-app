...
import{ DetailPage, HomePage, LoginPage, RegisterPage, StorePage, NewArticlePage, EditArticlePage } from '../containers'
...
export  function Routers() {
    return(
        <Switch>
               ...
               <PrivateRouter exact layout={MainLayout} component={NewArticlePage} path="/me/new-article" />
